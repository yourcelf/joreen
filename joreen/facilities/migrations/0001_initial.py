        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        help_text="Facility code provided by facility administrator (e.g. BoP, CCA, etc)",
                        max_length=255,
                    ),
                ),
                (
                    "name",
                    models.CharField(
                        help_text="Canonical name for the facility", max_length=255
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="e.g. Corrections Corporation of America",
                        max_length=255,
                    ),
                ),
            ],
