...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='facility',
            name='code',
            field=models.CharField(max_length=255, blank=True, help_text='Facility code provided by facility administrator. Should be unique per department of corrections.'),
        ),
        migrations.AlterField(
            model_name='facility',
            name='provenance',
