...
class TestAddressMatching(TestCase):
    ...
    def test_byrd(self):
        ...
        self.assertRaises(ValidationError,
                lambda: Address.from_zoho(self.mod(byrd_unit_zoho, {'Zip': '1234'})).validate())
        self.assertRaises(ValidationError,
    ...
    def test_apalachee(self):
        ...
        self.check_address_match(apalachee_east_zoho, apalachee_east_facility, {
            'AddressNumber': 100,
            'StreetName': 100,
    ...
    def test_avenal(self):
        ...
        self.check_address_match(avenal_zoho, avenal_facility, {
            'USPSBoxID': 100,
            'USPSBoxType': 100,
            'city': 100,
    ...
    def test_fci_num_1(self):
        ...
        self.check_address_match(
            ...
            vim,
            {
                'USPSBoxID': 100, 'USPSBoxType': 100, 'city': 100, 'name': 24,
                'street_total': 100.0
            }
        )
