    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=255, choices=[('ok', 'Address OK'), ('not found', 'Not Found'), ('unknown facility', 'Unknowon Facility'), ('seemingly released', 'Seemingly Released')])),
